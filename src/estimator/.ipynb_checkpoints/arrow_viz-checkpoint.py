"""Track visualization: export CoTracker arrows consistent with the official pipeline.

This utility reproduces the exact *tracking* inputs used by the main pipeline
(crop/pad/resize + CLAHE + CoTracker dense grid), then draws vectors either on:
  - the resized ROI (exactly what CoTracker saw), or
  - the original ROI crop (cleaner arrows, higher resolution).
"""
